...
modelNameMapping = {
    "baichuan": "Baichuan Vicuna 7b",
    "gpt35": "ChatGPT-3.5",
    "gpt4": "GPT-4",
    "alpaca": "Alpaca-13b",
    "vicuna": "LLaMA Vicuna 13b",
    "llama": "LLaMA-13b"
};
...
function displayAnswers(index) {
    ...
    score_text = modelNameMapping[otherModel] + " " + score[0] + "/10, LLaMA-Vicuna-13b " + score[1] + "/10";
    ...
    let assistant2_title = "Assistant #2 (LLaMA Vicuna 13B 20230322-new-hp-fp16)";
    // Update scores/labels.
    let assistant1_score_label = score[0].toString() + '/10';
    let assistant2_score_label = score[1].toString() + '/10';

    const colorRed ='rgb(255, 207, 202)'; // '#eb978d';
    // const colorGreen = '#c9f2c9';
    const colorBlue = 'rgb(221, 255, 235)'; // '#71dbf9';
    const colorYellow = 'rgb(200, 220, 255)'; // '#fada57';
